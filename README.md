...
Após a obtenção dos resultados, foi elaborada uma [planilha](https://gist.github.com/DavydKennyd/5515761db37399bc27d3005c28764230#file-gistfile1-txt "planilha") no Excel para registrar os dados de desempenho de cada método de ordenação. Cada método foi executado cinco vezes, e a média dos tempos de execução foi calculada para uma análise mais precisa. Essa abordagem permitirá a identificação do método que apresenta o melhor desempenho em termos de tempo de execução.
